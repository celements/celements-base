...
public class ObjectPropertyReferenceTest {
  ...
  public void testConstructors() {
    ObjectPropertyReference reference = new ObjectPropertyReference(
        new EntityReference("property", EntityType.OBJECT_PROPERTY,
  ...
  public void testInvalidType() {
    try {
      ...
      assertEquals("Invalid type [DOCUMENT] for an object property reference",
          expected.getMessage());
    }
  }
  ...
  public void testInvalidParentType() {
    try {
      ...
      assertEquals(
          "Invalid parent reference [Space] in an object property reference",
          expected.getMessage());
    }
  }
}
