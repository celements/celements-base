...
public class ObjectReferenceTest {
  ...
  public void testConstructors() {
    ObjectReference reference = new ObjectReference(new EntityReference("Object", EntityType.OBJECT,
        new EntityReference("Page",
            EntityType.DOCUMENT,
  ...
  public void testInvalidParentType() {
    try {
      new ObjectReference(
          new EntityReference("className", EntityType.OBJECT, new EntityReference("Space",
              EntityType.SPACE)));
      fail("Should have thrown exception");
    } catch (IllegalArgumentException expected) {
      assertEquals(
