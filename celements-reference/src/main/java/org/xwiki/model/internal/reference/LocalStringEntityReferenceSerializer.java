...
/**
 * Generate a string representation of an entity reference but without the wiki reference name
 * specified (eg
 * "space.page" for a document reference). This is an implementation use for backward compatibility
 * only and it should
 * be dropped in the future since there's no reason to not output the wiki name systematically
 * (usually we don't want to
 * print it but only if it's the same as the current wiki).
 *
 * @version $Id: 7a1c0dffa6f03e007a9a7cb93bc4f59a6dcbbd1e $
 * @since 2.2M1
