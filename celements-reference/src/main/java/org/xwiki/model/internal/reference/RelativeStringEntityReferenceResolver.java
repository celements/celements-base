...
/**
 * Resolve {@link org.xwiki.model.reference.EntityReference} objects from its string
 * representations. This
 * implementation doesn't generate absolute references; instead it stores the the representation
 * into an
