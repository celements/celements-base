...
/**
 * Generic entity reference resolver deferring resolution and default values to extending classes
 * but resolving
 * default value from the first optional parameter when provided and is an instance of a entity
 * reference. This
 * is use by most resolver to provide relative resolution to a provided reference.
 *
 * @version $Id: 6759c4e52b89696965d15abb4996aa2f43a2f3fc $
 * @since 3.3M2
 */
public abstract class AbstractEntityReferenceResolver {
   ...
   *
   * @param type
   *          the type for which a default name is requested
   * @param parameters
   *          optional parameters, if the first parameter is an entity reference which is of the
   *          given type
   *          or contains the given types in its parent chain, use the name of the reference having
   *          the requested type in
