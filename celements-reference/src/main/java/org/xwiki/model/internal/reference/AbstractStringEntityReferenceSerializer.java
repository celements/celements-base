 ...
 *
 * @version $Id: e128c755a046a7a5b53b6b0b5f4be20f02fea3a5 $
 * @since 3.3M2
 */
public abstract class AbstractStringEntityReferenceSerializer
   ...
   *          the builder where to happen the serialized member
   * @param isLastReference
   *          indicate if it's the last member of the reference
   * @param parameters
   *          optional parameters
   */
  protected abstract void serializeEntityReference(EntityReference currentReference,
