 ...
 * considered a helper
 * component to resolve {@link AttachmentReference} objects from their string representation. This
 * implementation uses
 * fixed default values when parts of the Reference are missing in the string representation.
 * Default values are
