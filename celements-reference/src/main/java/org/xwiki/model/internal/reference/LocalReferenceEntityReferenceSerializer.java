...
/**
 * Generate a entity reference but without the wiki reference part. This is an implementation use
 * for backward
 * compatibility only and it should be dropped in the future since there's no reason to remove the
 * wiki name
 * systematically
