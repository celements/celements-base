...
public interface EntityReferenceResolver<T> {
  ...
  /**
   * @param entityReferenceRepresentation
   *          the representation of an entity reference (eg as a String)
   * @param type
   *          the type of the Entity (Document, Space, Attachment, Wiki, etc) to resolve out of the
   *          representation
   * @param parameters
