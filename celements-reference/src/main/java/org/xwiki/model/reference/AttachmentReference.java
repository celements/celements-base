...
public class AttachmentReference extends EntityReference {
   ...
   *
   * @param reference
   *          the reference to be transformed
   ...
   * @since 3.3M2
   */
  protected AttachmentReference(EntityReference reference, EntityReference oldReference,
      EntityReference newReference) {
    super(reference, oldReference, newReference);
  }

  /**
   * Create a new attachment reference based on the attachment name and the parent document
   * reference.
   *
   * @param fileName
