...
public class DocumentReference extends EntityReference {
   ...
   * @since 3.3M2
   */
  protected DocumentReference(EntityReference reference, EntityReference oldReference,
   ...
   *
   * @param wikiName
   *          the name of the wiki containing the document, must not be null
   * @param spaceName
   *          the name of the space containing the document, must not be null
   * @param pageName
   ...
   * This is an helper function during transition from language to locale, it will be deprecated
   * ASAP.
   *
   * @param wikiName
   *          the name of the wiki containing the document, must not be null
   ...
   *          the name of the wiki containing the document, must not be null
   * @param spaceNames
   *          an ordered list of the names of the spaces containing the document from root space to
   *          last one,
   *          must not be null
   * @param pageName
   *          the name of the document
   ...
   *          must not be null
   * @param pageName
   *          the name of the document reference
   * @param locale
   *          the locale of the document reference, may be null
   */
  public DocumentReference(String wikiName, List<String> spaceNames, String pageName,
   ...
   * @exception IllegalArgumentException
   *              if the passed type is not a document type
   */
  @Override
   ...
   *          the wikiname
   * @param spaceNames
   *          the list of space name from root to child
