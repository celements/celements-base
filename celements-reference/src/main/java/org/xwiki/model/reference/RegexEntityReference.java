 ...
 * <p>
 * This {@link EntityReference} contains a {@link Pattern} which will tries to match provided
 * {@link EntityReference}
 * name and type.
 * <p>
 * The {@link RegexEntityReference} can be partial or contain holes, for example if only the space
 * regex reference is
 * provided it will tries to match only space part of the provided reference and consider other
 * parts as matched.
 * <p>
 * It's of course possible to mix regex and "normal" {@link EntityReference} member. In that case
 * normal member
