...
public class SpaceReference extends EntityReference {
   ...
   *
   * @param reference
   *          the entity reference to transforms
   * @exception IllegalArgumentException
   *              if the passed reference is not a valid space reference
   */
   ...
   * @since 3.3M2
   */
  protected SpaceReference(EntityReference reference, EntityReference oldReference,
   ...
   * @exception IllegalArgumentException
   *              if the passed type is not a space type
   */
  @Override
