 ...
 * {@link ObjectReference} object, i.e.
 * with valid values and a valid hierarchy (e.g. an Object reference must have a parent which is a
 * document reference,
 * reference values must not be null, etc).
 *
 * @param <T>
 *          the type of the representation (e.g. a String)
 * @version $Id: 96eccd8a7e082e7e94289a4309ddc2c42c7d273a $
 * @since 2.3M1
 */
@ComponentRole
public interface ObjectReferenceResolver<T> {
  ...
  /**
   * @param objectReferenceRepresentation
