...
public class VelocityParser extends AbstractLogEnabled {
  ...
  /**
   * Get any valid Velocity block starting with a sharp character (#if, #somemaccro(), ##comment
   * etc.).
   *
   * @param array
   *          the source to parse
   ...
   */
  public int getKeyWord(char[] array, int currentIndex, StringBuffer velocityBlock,
   ...
   *           not a valid velocity block
   */
  public int getDirective(char[] array, int currentIndex, StringBuffer velocityBlock,
      VelocityParserContext context)
      throws InvalidVelocityException {
    ...
    if (VELOCITYDIRECTIVE_ALL.contains(directiveName)) {
      if (VELOCITYDIRECTIVE_BEGIN.contains(directiveName)) {
        context.pushVelocityElement(
            new VelocityBlock(directiveName, VelocityBlock.VelocityType.DIRECTIVE));
   ...
   * {@link #getVelocityIdentifier(char[], int, StringBuffer, VelocityParserContext)} because is
   ...
   *           not a valid velocity block
   */
  public int getDirectiveName(char[] array, int currentIndex, StringBuffer directiveName,
      StringBuffer velocityBlock,
      VelocityParserContext context) throws InvalidVelocityException {
    int i = currentIndex;
   ...
   *           not a valid velocity block
   */
  public int getVar(char[] array, int currentIndex, StringBuffer velocityBlock,
      VelocityParserContext context)
      throws InvalidVelocityException {
   ...
   *           not a valid velocity block
   */
  public int getVar(char[] array, int currentIndex, StringBuffer varName,
      StringBuffer velocityBlock,
      VelocityParserContext context) throws InvalidVelocityException {
   ...
   * @return the index in the <code>array</code> after the matched block
   */
  private int followVar(char[] array, int currentIndex, boolean fullSyntax,
      VelocityParserContext context) {
    int i = currentIndex;
   ...
   * @return the index in the <code>array</code> after the matched block
   */
  public int getParameters(char[] array, int currentIndex, StringBuffer velocityBlock,
      char endingChar,
      VelocityParserContext context) {
   ...
   * @return the index in the <code>array</code> after the matched block
   */
  public int getEscape(char[] array, int currentIndex, StringBuffer velocityBlock,
      VelocityParserContext context) {
