...
/**
 * Velocity Tool offering various Regex-based APIs to make it easy to manipulate regular expressions
 * from Velocity.
 *
 * @version $Id$
 * @since 2.0RC2
...
public class RegexTool {
   ...
   * @return empty list if the passed regex doesn't match the content or several {@link RegexResult}
   *         objects
   *         containing the matched position and matched content for all capturing groups, the first
   *         group
   ...
   * @return the {@code Pattern} object corresponding to the regular expression, or {@code null} if
   *         the expression is
   *         invalid
   * @since 2.3M1
   */
