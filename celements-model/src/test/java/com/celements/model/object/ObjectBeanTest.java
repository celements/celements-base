...
public class ObjectBeanTest extends AbstractComponentTest {
  ...
  @Test
  public void test_equals_notEquals_number() {
    DocumentReference docRef = new DocumentReference("wikiName", "space", "document");
    Integer number = 2;
    objectBean.setDocumentReference(docRef);
    objectBean.setClassReference(TestClassDefinition.CLASS_REF);
  ...
  public void test_toString() {
    DocumentReference docRef = new DocumentReference("wikiName", "space", "document");
    ClassReference classReference = TestClassDefinition.CLASS_REF;
    Integer number = 2;
    objectBean.setDocumentReference(docRef);
    objectBean.setClassReference(classReference);
    objectBean.setNumber(number);
    assertEquals("ObjectBean [documentReference=" + docRef + ", classReference=" + classReference
        + ", number=" + number + "]", objectBean.toString());
  }
  ...
  public void test_ObjectBean_bean() {
    ...
    objectBeanObj.setNumber(number);
    try {
