...
public class ExoAuthServiceImpl extends XWikiAuthServiceImpl {
  ...
  protected SecurityService getSecurityService() {
    if (securityService_ == null) {
      ...
      securityService_ = (SecurityService) manager
  ...
  public String getExo_DN(String susername, XWikiContext context) {
    ...
    if (context != null) {
      ...
      if (!context.isMainWiki() && ((EX == null) || (EX.length() == 0))) {
  ...
  private void CreateUserFromExo(String susername, HashMap attributes, XWikiContext context)
      throws XWikiException {
    ...
    if ((param == null) || "".equals(param)) {
      try {
        param = context.getWiki()
            .Param("xwiki.authentication." + StringUtils.replace(name, "exo_", "exo."));
      } catch (Exception e) {}
    }
    if (param == null) {
      param = "";
