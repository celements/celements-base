...
public class DomainObjectFactory {
  ...
  public static XWikiClass createXWikiClass(com.xpn.xwiki.api.Class xwikiClass) {
    Map<String, Map<String, Object>> userClassPropertyToAttributesMap = new HashMap<>();
    ...
    for (Object o : xwikiClass.getProperties()) {
      ...
      attributeToValueMap.put(XWikiClass.XWIKICLASS_ATTRIBUTE,
          userClassProperty.getxWikiClass().getName());
  ...
  private static com.xpn.xwiki.objects.classes.PropertyClass getPropertyType(
      ...
      XWikiContext xwikiContext, com.xpn.xwiki.api.Object object, String propertyName)
      throws XWikiException {
