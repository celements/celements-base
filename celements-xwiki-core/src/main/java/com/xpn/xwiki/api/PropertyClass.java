 ...
 * </p>
 * <p>
 * A <strong>property definition</strong> is the instantiation of a
 * {@link com.xpn.xwiki.objects.meta.PropertyMetaClass}
 * for a particular <strong>Object definition</strong> ({@link Class XClass}), that customizes a
 * property type to suit
...
public class PropertyClass extends Collection implements Comparable<PropertyClass> {
   ...
   * {@link com.xpn.xwiki.objects.classes.PropertyClass}, given a
   * {@link com.xpn.xwiki.XWikiContext context}.
   *
   * @param property
   *          the property definition to wrap
   * @param context
  ...
  /**
   * Get the full name of the actual class of the wrapped
   * {@link com.xpn.xwiki.objects.classes.PropertyClass}. The
   * returned value is the canonical class name of the runtime object representing this property
   * definition, for
  ...
  /**
   * Get the actual type of the wrapped {@link com.xpn.xwiki.objects.classes.PropertyClass}. The
   * returned value is
   * extracted from the class name of the runtime object representing this property definition, and
   * denotes a
   * user-friendly data type name, for example {@code StringClass}, {@code NumberClass} or
   * {@code StaticListClass}.
   *
  ...
  /**
   * Get the name of the {@link com.xpn.xwiki.api.Class XClass} (Object Definition) this property
   * definition belongs
  ...
  /**
   * Provides access to the wrapped {@link com.xpn.xwiki.objects.classes.PropertyClass} if
  ...
  /**
   * Get the untranslated user-friendly name of this property. For example, {@code User type}
  ...
  /**
   * Get the message that should be displayed when a value for an instance of this property
   * definition fails the
   * validation. For example, {@code Please enter a valid IP address}.
   *
   * @return the configured validation message
   * @see #getValidationRegExp() {@code getValidationRegExp()} returns the regular expression used
   *      for validating the
   *      property value
   */
  ...
  /**
   * Get the regular expression used for validating a value for an instance of this property
   * definition.
   *
   * @return a string representation of the validation regular expression
   * @see #getValidationMessage() {@code getValidationMessage()} returns the message that should be
   *      displayed in case
  ...
  /**
   * Get a tooltip string that should be displayed for input fields for instances of this property
   * definition.
   *
   * @return A raw tooltip string. The value does not escape special HTML characters, so the caller
   *         should manually
   *         escape quotes if the tooltip should be used as a value for the HTML {@code title}
   *         attribute.
   */
  ...
  /**
   * If the property is a {@link ListClass}, returns the possible values. These are the internal
   * values (keys), and
   ...
   * @see #getMapValues() {@code getMapValues()} returns both the keys and their user-friendly
   *      displayed values
   **/
  public List<String> getListValues() {
    ...
    if (pclass instanceof ListClass) {
      ...
      // Although we prefer to return empty lists from API methods, here returning any kind of list
      // doesn't make
      // sense, since the property does not have a list of possible values at all (like, a number
      // property).
      return null;
    }
  }
   ...
   * {@code internal key <-> displayed
   * value}.
   *
   * @return the map of possible ({@code String}) values and their associated ({@code ListItem})
   *         displayed values
  ...
  public Map<String, ListItem> getMapValues() {
    ...
    if (pclass instanceof ListClass) {
      ...
      // Although we prefer to return empty maps from API methods, here returning any kind of map
      // doesn't make
      // sense, since the property does not have a list of possible values at all (like, a number
      // property).
      return null;
