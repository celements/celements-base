...
public class Period {
   ...
   */
  private static final DateTimeFormatter DAY_PERIOD_FORMATTER = DateTimeFormat
      .forPattern("yyyyMMdd");

  /**
   * Formatter associated with periods that have at least one month
   */
  private static final DateTimeFormatter MONTH_PERIOD_FORMATTER = DateTimeFormat
      .forPattern("yyyyMM");

  private Interval interval;

  /**
   * Creates a new time Period from the specified start time to the specified end time. Both ends of
   * the period are
  ...
  /**
   * @return The end of the period formatted with the associated formatter. Usually this is how the
   *         end of the period
