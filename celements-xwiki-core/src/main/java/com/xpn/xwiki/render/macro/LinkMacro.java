...
/**
 * Radeox macro for the xwiki 1.0 syntax, offering linking capabilities. Syntax:
 * <tt>{link:text|url|image}</tt>
 * <dl>
 * <dt>text</dt>
 * <dd>The link text.</dd>
 * <dt>url</dt>
...
public class LinkMacro extends BaseLocaleMacro {
  ...
  public void execute(Writer writer, MacroParameter params)
    ...
    if (params.getLength() == 1) {
      url = text;
      // Since this is an URL, escape the first character in order to prevent starting the
      // linkfilter.
