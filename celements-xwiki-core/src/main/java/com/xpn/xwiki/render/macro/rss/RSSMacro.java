...
public class RSSMacro extends BaseLocaleMacro {
   ...
   *           from calls to <code>writer.write()</code>
   ...
   * @throws java.io.IOException
   */
  private void renderEntries(SyndFeed feed, Writer writer, RSSMacroParameters paramObj)
      throws java.io.IOException {
   ...
   *           from calls to <code>writer.write()</code>
   */
  private void renderEntry(SyndEntry entry, Writer writer, RSSMacroParameters paramObj)
      throws java.io.IOException {
   ...
   * <li>If present, the item description is wrapped in <code>&lt;div
   * class='rss.item.description'&gt;</li>
   * </ul>
   *
   * @param buf
   *          the StringBuffer we're using to prepare the output
   ...
   *
   * @param feed
   *          the RSS Channel we retrieved via the Feed URL
   * @param writer
   *          the output writer
   * @param paramObj
   *          our parameter helper object
   ...
   *           from calls to <code>writer.write()</code>
   */
  private void renderTitle(SyndFeed feed, Writer writer, RSSMacroParameters paramObj)
      throws java.io.IOException {
    StringBuffer buf = new StringBuffer();
    if (paramObj.isCss()) {
   ...
   *           from calls to <code>writer.write()</code>
   */
  private void renderImage(SyndFeed feed, Writer writer, RSSMacroParameters paramObj)
      throws java.io.IOException {
    if ((feed.getImage() == null) || !(paramObj.isImg())) {
      return;
    }
   ...
   *           from calls to <code>writer.write()</code>
   */
  private void renderSearch(SyndFeed feed, Writer writer, RSSMacroParameters paramObj)
      throws java.io.IOException {
   ...
   *         <li>?css: if 'true', elements will be created with CSS styles; otherwise, static
   *         formatting methods will be used</li>
   *         <li>?count: an integer, the maximum number of feed items to display</li>
   *         <li>?full: if 'true', descriptions for each item will be included. Otherwise, just
   *         titles.</li>
