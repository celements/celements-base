...
public class XWikiScriptContextInitializer implements ScriptContextInitializer {
  ...
  public void initialize(ScriptContext scriptContext) {
    ...
    if (scriptContext.getAttribute("util") == null) {
      ...
      scriptContext.setAttribute("xwiki", new XWiki(xcontext.getWiki(), xcontext),
          ScriptContext.ENGINE_SCOPE);
    ...
    if (xcontext.getDoc() != null) {
      scriptContext.setAttribute("doc", xcontext.getDoc().newDocument(xcontext),
          ScriptContext.ENGINE_SCOPE);
      scriptContext.setAttribute("cdoc", scriptContext.getAttribute("doc"),
          ScriptContext.ENGINE_SCOPE);
      scriptContext.setAttribute("tdoc", scriptContext.getAttribute("doc"),
          ScriptContext.ENGINE_SCOPE);
    }
  }
}
