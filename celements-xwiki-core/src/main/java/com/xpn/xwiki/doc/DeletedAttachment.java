...
public class DeletedAttachment extends AbstractSimpleClass {
   ...
   * Getter for {@link #id}.
   *
   * @return The synthetic id of this deleted attachment. Uniquely identifies an entry in the
   *         recycle bin.
   */
  public long getId() {
    return this.id;
   ...
   *
   * @param xml
   *          XML serialization of {@link XWikiAttachment}. Used only by Hibernate.
   */
  ...
  /**
   * Restore a {@link XWikiAttachment} from a {@link DeletedAttachment}. Note that this method does
   * not actually
   * restore the attachment to its owner document, it simply recomposes an {@link XWikiAttachment}
   * object from the
   * saved data.
   *
   * @return restored attachment
   * @param attachment
   *          optional object where to put the attachment data, if not <code>null</code>
   * @param context
