...
public class XWikiDeletedDocument extends AbstractSimpleClass {
  ...
  /**
   * @param docFullName
   *          - {@link XWikiDocument#getFullName()} to set
   */
  ...
  /**
   * @param language
   *          - {@link XWikiDocument#getLanguage()} to set
   */
  ...
  /**
   * @param xml
   *          - xml serialization of {@link XWikiDocument}
   */
   ...
   *          - deleted document
   * @param context
   *          - used in {@link XWikiDocument#toXML(XWikiContext)}
   * @throws XWikiException
   *           in error in {@link XWikiDocument#toXML(XWikiContext)}
   */
   ...
   * @throws XWikiException
   *           if error in {@link XWikiDocument#fromXML(String)}
   */
