...
public class Util {
  ...
  /**
   * Create a Map from a string holding a space separated list of key=value pairs. If keys or values
   * must contain
   * spaces, they can be placed inside quotes, like <code>"this key"="a larger value"</code>. To use
   * a quote as part
