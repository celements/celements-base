...
public class DefaultChartParams2 extends ChartParams {
  ...
  void setAxis(String prefix) throws ParamException {
    ...
    set(prefix + AXIS_TICK_MARK_INSIDE_LENGTH_SUFFIX,
        new Float(Axis.DEFAULT_TICK_MARK_INSIDE_LENGTH));
    set(prefix + AXIS_TICK_MARK_OUTSIDE_LENGTH_SUFFIX,
        new Float(Axis.DEFAULT_TICK_MARK_OUTSIDE_LENGTH));
    ...
    set(prefix + VALUE_AXIS_AUTO_RANGE_MIN_SIZE_SUFFIX,
        new Double(ValueAxis.DEFAULT_AUTO_RANGE_MINIMUM_SIZE));
    set(prefix + VALUE_AXIS_AUTO_TICK_UNIT_SUFFIX,
        new Boolean(ValueAxis.DEFAULT_AUTO_TICK_UNIT_SELECTION));
    ...
    set(prefix + CATEGORY_AXIS_CATEGORY_MARGIN_SUFFIX,
        new Double(CategoryAxis.DEFAULT_CATEGORY_MARGIN));
  ...
  /*
   * // DefaultDrawingSupplier addParam(new ListChartParam(new
   * ColorChartParam(RENDERER_SERIES_COLORS))); addParam(new
