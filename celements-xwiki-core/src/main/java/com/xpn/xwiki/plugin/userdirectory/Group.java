...
public class Group {
   ...
   *
   * @param name
   *          the name of the page of the parent group
   * @param context
   * @return false if the group is already parent of this one
   * @throws XWikiException
   *           if the parent group doesn't exist
   */
  public boolean addParentName(String name, UserDirectoryPlugin userDirPlugin, XWikiContext context)
    ...
    if (parentGroup.isNew()) {
      throw new PluginException(UserDirectoryPlugin.class,
          ERROR_USERDIRECTORYPLUGIN_GROUP_DOESNT_EXIST,
  ...
  protected static BaseClass getXWikiDirectoryGroupClass(XWikiContext context)
      throws XWikiException {
    XWikiDocument doc;
    XWiki xwiki = context.getWiki();
    boolean needsUpdate = false;
  ...
  public static Group getGroup(String space, String name, XWikiContext context)
      throws XWikiException {
  ...
  public static List getAllGroupsPageName(String orderBy, XWikiContext context)
      throws XWikiException {
    String className = getXWikiDirectoryGroupClass(context).getName();
