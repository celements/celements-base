...
public class FrenchStemmer {
   ...
   */
  private void step1() {
    String[] suffix = { "ances", "iqUes", "ismes", "ables", "istes", "ance", "iqUe", "isme", "able",
        "iste" };
   ...
   */
  private void step2b() {
    String[] suffix = { "eraIent", "erais", "erait", "erai", "eras", "erions", "eriez", "erons",
        "eront",
        "erez", "\u00e8rent", "era", "\u00e9es", "iez", "\u00e9e", "\u00e9s", "er", "ez",
        "\u00e9" };
    deleteFrom(RV, suffix);

    String[] search = { "assions", "assiez", "assent", "asses", "asse", "aIent", "antes", "aIent",
        "Aient",
   ...
   * @param prefix
   *          java.lang.String - the prefix to add to the search string to test
  ...
  private boolean deleteFromIfPrecededIn(String source, String[] search, String from,
    ...
    if (source != null) {
      for (String element : search) {
        if (source.endsWith(element) && ((from != null) && from.endsWith(prefix + element))) {
          sb.delete(sb.length() - element.length(), sb.length());
          found = true;
          setStrings();
          break;
        }
  ...
  private boolean deleteFromIfTestVowelBeforeIn(String source, String[] search, boolean vowel,
    ...
    if ((source != null) && (from != null)) {
      for (String element : search) {
        if (source.endsWith(element) && ((element.length() + 1) <= from.length())) {
          boolean test = isVowel(sb.charAt(sb.length() - (element.length() + 1)));
          if (test == vowel) {
            sb.delete(sb.length() - element.length(), sb.length());
            modified = true;
            found = true;
  ...
  private void deleteButSuffixFrom(String source, String[] search, String prefix,
    ...
    if (source != null) {
      for (String element : search) {
        if (source.endsWith(prefix + element)) {
          sb.delete(sb.length() - (prefix.length() + element.length()), sb.length());
          modified = true;
          setStrings();
          break;
        } else if (without && source.endsWith(element)) {
          sb.delete(sb.length() - element.length(), sb.length());
          modified = true;
          setStrings();
          break;
    ...
    if (source != null) {
      for (String element : search) {
        if (source.endsWith(prefix + element)) {
          ...
          setStrings();
          break;
        } else if ((from != null) && from.endsWith(prefix + element)) {
          sb.replace(sb.length() - (prefix.length() + element.length()), sb.length(),
              replace);
          modified = true;
          setStrings();
          break;
    ...
    if (source != null) {
      for (String element : search) {
        if (source.endsWith(element)) {
          sb.replace(sb.length() - element.length(), sb.length(), replace);
          modified = true;
          found = true;
          setStrings();
          break;
  ...
  private StringBuffer treatVowels(StringBuffer buffer) {
    for (int c = 0; c < buffer.length(); c++) {
      ...
      {
        if ((ch == 'u') && ((buffer.charAt(c - 1) == 'q')
            || (isVowel(buffer.charAt(c - 1)) && isVowel(buffer.charAt(c + 1))))) {
          buffer.setCharAt(c, 'U');
        }
