...
/**
 * Action responsible for downloading temporary resources created by various modules. Refer JIRA
 * issue:
...
public class TempResourceAction extends XWikiAction {
   ...
   * @param context
   *          xwiki context.
   * @return temporary file corresponding to the specified URI or null if no such file can be
   *         located.
  ...
  /**
   * Keeps only minimal URL encoding. Currently, XWiki's URL factory over encodes the URLs in order
   * to protect them
