...
/**
 * Note: We store the class name as a String and not a Document Reference since Struts Form beans
 * are called before
 * there's an Execution Context available and before there's a current document in the Execution
 * Context. This bean
