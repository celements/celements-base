...
/**
 * A simple action that redirects to the main page of the wiki. This is to allow users to enter a
 * URL like
...
public class HomePageRedirectServlet extends HttpServlet {
  ...
  public void init() throws ServletException {
    super.init();
    // TODO: we cannot use the XWiki API to determine the right URL, because this is a servlet and
    // the core
    // is reachable mainly from Struts. Getting access to the core requires too much duplication, so
    // for the
