...
public class XWikiPortletURLFactory extends XWikiServletURLFactory {
   ...
   * {@inheritDoc}
   *
   * @see com.xpn.xwiki.web.XWikiDefaultURLFactory#createAttachmentURL(java.lang.String,
   *      java.lang.String,
  ...
  public URL createAttachmentURL(String filename, String web, String name, String action,
    ...
    try {
      ...
      if (action.equals("download")) {
        return super.createAttachmentURL(filename, web, name, action, xwikidb, context); // To
                                                                                         // change
                                                                                         // body of
      }
  ...
  public URL createURL(String web, String name, String action, String querystring, String anchor,
    ...
    try {
      if (LOG.isDebugEnabled()) {
        LOG.debug(
            "Generating URL for: " + xwikidb + ":" + web + "." + name + " for action " + action
      ...
      if (action.equals("view") || action.equals("viewrev") || action.equals("attach")
          || action.equals("download") || action.equals("downloadrev")
          || action.equals("viewattachrev")
   ...
   * {@inheritDoc}
   *
   * @see com.xpn.xwiki.web.XWikiServletURLFactory#createExternalURL(java.lang.String,
   *      java.lang.String,
   ...
   * {@inheritDoc}
   *
   * @see com.xpn.xwiki.web.XWikiServletURLFactory#getServerURL(java.lang.String,
   *      com.xpn.xwiki.XWikiContext)
   */
  @Override
