...
public abstract class XWikiAction extends Action {
      ...
      try {
        ...
        try {
          ...
          if (xex.getCode() == XWikiException.ERROR_XWIKI_APP_SEND_RESPONSE_EXCEPTION) {
            ...
            xwiki.setPhonyDocument(xwiki.getDefaultSpace(context) + "." + xwiki.getDefaultPage(
                context),
                context, vcontext);
  ...
  protected XWikiContext initializeXWikiContext(ActionMapping mapping, ActionForm form,
    ...
    XWikiContext context = Utils.prepareContext(action, request, response, new XWikiServletContext(
  ...
  protected void initializeContainerComponent(XWikiContext context) throws ServletException {
    ...
    ServletContainerInitializer containerInitializer = Utils.getComponent(
  ...
  protected boolean sendGlobalRedirect(XWikiResponse response, String url, XWikiContext context)
    ...
    if ("1".equals(context.getWiki().Param("xwiki.preferences.redirect"))) {
      ...
      // modified.
      XWikiDocument globalPreferences = context.getWiki().getDocument(
  ...
  protected XWikiDocument getTranslatedDocument(XWikiDocument doc, String language,
      ...
      throws XWikiException {
    XWikiDocument tdoc;
    if (StringUtils.isBlank(language) || language.equals("default") || language.equals(doc
        .getDefaultLanguage())) {
      tdoc = doc;
    } else {
