...
/**
 * Base class for manipulating property definitions: disable, enable, delete. The property to alter
 * is specified in the
...
public abstract class AbstractPropChangeAction extends XWikiAction {
   ...
   * @return {@code false} if the operation succeeded and the response is finished, {@code true} if
   *         the response must
   ...
   */
  public abstract void changePropertyDefinition(BaseClass xclass, String propertyName,
