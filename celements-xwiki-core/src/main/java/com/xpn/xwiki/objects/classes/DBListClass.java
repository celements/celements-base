...
public class DBListClass extends ListClass {
  ...
  public Map<String, ListItem> getMap(XWikiContext context) {
    ...
    Map<String, ListItem> result = new HashMap<>();
   ...
   * <tt>classname</tt>,
   * <tt>idField</tt> and <tt>valueField</tt> properties. The query is constructed according to the
   * following rules:
   * </p>
   * <ul>
   ...
   * </ul>
   * <p>
   * If there are two columns selected, use the first one as the stored value and the second one as
   * the displayed
   * value.
   * </p>
   *
