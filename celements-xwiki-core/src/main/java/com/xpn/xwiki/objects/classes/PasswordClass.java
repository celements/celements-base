...
public class PasswordClass extends StringClass {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(PasswordClass.class);
  ...
  public BaseProperty fromString(String value) {
    ...
    if (value.startsWith(HASH_IDENTIFIER + SEPARATOR)
  ...
  /**
   * Transforms a plain text password so that it has the same encryption as a password stored in the
   * database. The
   * current configuration for this password XProperty cannot be used, as the user might have a
