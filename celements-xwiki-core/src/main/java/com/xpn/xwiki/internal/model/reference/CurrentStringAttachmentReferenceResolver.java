 ...
 * considered a helper component to resolve {@link AttachmentReference} objects from their string
 ...
 *
 * @version $Id: 7ad10810eb04034c9e2db6bbbe33ca108957ec41 $
 * @since 2.2M1
 */
@Component("current")
@Singleton
public class CurrentStringAttachmentReferenceResolver
  ...
  public AttachmentReference resolve(String attachmentReferenceRepresentation,
      Object... parameters) {
    return new AttachmentReference(entityReferenceResolver.resolve(
