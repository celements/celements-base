...
public class WikiMacrosTest extends AbstractBridgedComponentTestCase {
  ...
  public void setUp() throws Exception {
    ...
    this.wikiMacroEventListener = getComponentManager().lookup(EventListener.class,
        "wikimacrolistener");
  ...
  public void testSaveWikiMacro() throws Exception {
    final DocumentCreatedEvent documentCreatedEvent = new DocumentCreatedEvent(
        new DocumentReference("wiki", "Space", "Name"));
