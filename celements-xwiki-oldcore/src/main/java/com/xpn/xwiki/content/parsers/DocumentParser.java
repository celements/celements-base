...
public class DocumentParser implements ContentParser {
   ...
   *          the raw document content to parse.
   * @param linkToLookFor
   *          the link to look for that will be replaced by the new link
   * @param newLink
   *          the new link
   * @param linkHandler
   ...
   *
   * @param parser
   *          the link parser to use for parsing the link
   * @param linkContent
   *          the content to parse
   * @param results
   *          the resulting collections of objects (valid elements, invalid elements) to
