...
public class TextAreaClass extends StringClass {
  ...
  public boolean isWikiContent() {
    ...
    if ((contentType != null) && !contentType.equals("puretext")
        && !contentType.equals("velocitycode")) {
      return true;
    } else {
      return false;
    }
   ...
   * {@inheritDoc}
   *
   * @see com.xpn.xwiki.objects.classes.StringClass#displayEdit(java.lang.StringBuffer,
   *      java.lang.String,
   ...
   * {@inheritDoc}
   *
   * @see com.xpn.xwiki.objects.classes.PropertyClass#displayView(java.lang.StringBuffer,
   *      java.lang.String,
   *      java.lang.String, com.xpn.xwiki.objects.BaseCollection, com.xpn.xwiki.XWikiContext)
   */
  @Override
  public void displayView(StringBuffer buffer, String name, String prefix, BaseCollection object,
    ...
    if ((contentType != null) && (doc != null) && (contentType.equals("puretext"))) {
    ...
    } else if ((contentType != null) && (context.getWiki() != null)
        && (contentType.equals("velocitycode"))) {
      ...
      super.displayView(result, name, prefix, object, context);
      if (doc != null) {
        buffer.append(doc.getRenderedContent(result.toString(), object.getDocumentSyntaxId(context),
            context));
      } else {
        buffer.append(result);
      }
