...
public interface XWikiVersioningStoreInterface {
  ...
  void loadXWikiDocArchive(XWikiDocumentArchive archivedoc, boolean bTransaction,
      XWikiContext context)
      throws XWikiException;

  void saveXWikiDocArchive(XWikiDocumentArchive archivedoc, boolean bTransaction,
      XWikiContext context)
      throws XWikiException;
  ...
  /**
   * Load {@link XWikiRCSNodeContent} by demand. Used in
   * {@link XWikiRCSNodeInfo#getContent(XWikiContext)}
   *
   * @return loaded rcs node content
   * @param id
   *          = {@link XWikiRCSNodeContent#getId()}
   */
  XWikiRCSNodeContent loadRCSNodeContent(XWikiRCSNodeId id, boolean bTransaction,
      XWikiContext context)
      throws XWikiException;
}
