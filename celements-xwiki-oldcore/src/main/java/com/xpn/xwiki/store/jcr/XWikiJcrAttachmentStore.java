...
public class XWikiJcrAttachmentStore extends XWikiJcrBaseStore
    implements XWikiAttachmentStoreInterface {

  public XWikiJcrAttachmentStore(XWiki xwiki, XWikiContext context) throws SecurityException,
      NoSuchMethodException, ClassNotFoundException, IllegalArgumentException,
      InstantiationException, IllegalAccessException, InvocationTargetException {
    super(xwiki, context);
  }

  public XWikiJcrAttachmentStore(XWikiContext context) throws SecurityException,
  ...
  @Override
  public void saveAttachmentContent(final XWikiAttachment attachment, final boolean bParentUpdate,
    ...
    try {
      ...
      executeWrite(context, session -> {
        ...
        Node attachNode = JcrUtil.getOrCreateSubNode(dirattNode, attachment.getFilename(),
            ntXWikiAttachment);
        Node attachContentNode = JcrUtil.getOrCreateSubNode(attachNode, "content",
            ntXWikiAttachmentContent);
        attachContentNode.setProperty("jcr:data", content.getContentInputStream());
        attachContentNode.setProperty("attach", attachNode);
        Node attachArchiveNode = JcrUtil.getOrCreateSubNode(attachNode, "archive",
            ntXWikiAttachmentArchive);
      ...
      throw new XWikiException(XWikiException.MODULE_XWIKI_STORE,
          XWikiException.ERROR_XWIKI_STORE_JCR_SAVING_ATTACHMENT,
          "Exception while saving attachment {0} of document {1}", e, args);
    }
  }

  @Override
  public void saveAttachmentsContent(List attachments, XWikiDocument doc, boolean bParentUpdate,
      XWikiContext context, boolean bTransaction) {
  ...
  public void loadAttachmentContent(XWikiAttachment attachment, XWikiContext context,
    ...
    try {
      ...
      Object[] args = { attachment.getFilename(), attachment.getDoc().getFullName() };
      throw new XWikiException(XWikiException.MODULE_XWIKI_STORE,
          XWikiException.ERROR_XWIKI_STORE_JCR_LOADING_ATTACHMENT,
          "Exception while loading attachment {0} of document {1}", e, args);
    }
  }

  protected byte[] getBytesFromProp(Property p)
  ...
  public void loadAttachmentArchive(XWikiAttachment attachment, XWikiContext context,
      boolean bTransaction) throws XWikiException {
    try {
  ...
  @Override
  public void deleteXWikiAttachment(final XWikiAttachment attachment, boolean parentUpdate,
    ...
    try {
      ...
      if (parentUpdate) {
        ...
        // save is not needed: context.getWiki().getStore().saveXWikiDoc(attachment.getDoc(),
        // context, false);
      }
    } catch (Exception e) {
      Object[] args = { attachment.getFilename(), attachment.getDoc().getFullName() };
      throw new XWikiException(XWikiException.MODULE_XWIKI_STORE,
          XWikiException.ERROR_XWIKI_STORE_JCR_DELETING_ATTACHMENT,
