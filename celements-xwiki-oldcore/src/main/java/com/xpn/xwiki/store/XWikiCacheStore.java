...
public class XWikiCacheStore implements XWikiCacheStoreInterface, EventListener {
  ...
  public XWikiCacheStore(XWikiStoreInterface store, XWikiContext context) throws XWikiException {
    ...
    this.remoteObservationManagerContext = Utils
        .getComponent(RemoteObservationManagerContext.class);
  ...
  public void saveXWikiDoc(XWikiDocument doc, XWikiContext context, boolean bTransaction)
     ...
     * introduce the
     * possibility for cache incoherince if the document is not saved in the database properly. In
     * addition, the
  ...
  public List<DocumentReference> searchDocumentReferences(String parametrizedSqlClause, int nb,
    ...
    return this.store.searchDocumentReferences(parametrizedSqlClause, nb, start, parameterValues,
        context);
  }
  ...
  public List<String> searchDocumentsNames(String parametrizedSqlClause, int nb, int start,
      List<?> parameterValues, XWikiContext context) throws XWikiException {
    return this.store.searchDocumentsNames(parametrizedSqlClause, nb, start, parameterValues,
        context);
  }
  ...
  public List<XWikiDocument> searchDocuments(String wheresql, boolean distinctbyname,
    ...
    return this.store.searchDocuments(wheresql, distinctbyname, customMapping, checkRight, nb,
        start, context);
  }
  ...
  public List<XWikiDocument> searchDocuments(String wheresql, boolean distinctbylanguage, int nb,
      int start,
      List<?> parameterValues, XWikiContext context) throws XWikiException {
    return this.store.searchDocuments(wheresql, distinctbylanguage, nb, start, parameterValues,
        context);
  }
  ...
  public List<XWikiDocument> searchDocuments(String wheresql, boolean distinctbylanguage,
    ...
    return this.store.searchDocuments(wheresql, distinctbylanguage, customMapping, nb, start,
        parameterValues,
        context);
  }
  ...
  public List<XWikiDocument> searchDocuments(String wheresql, boolean distinctbylanguage,
      ...
      throws XWikiException {
    return this.store.searchDocuments(wheresql, distinctbylanguage, customMapping, checkRight, nb,
        start,
