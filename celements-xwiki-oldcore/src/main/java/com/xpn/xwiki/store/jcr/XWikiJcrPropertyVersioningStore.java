...
public class XWikiJcrPropertyVersioningStore extends XWikiJcrBaseStore
    implements XWikiVersioningStoreInterface {

  public XWikiJcrPropertyVersioningStore(XWiki xwiki, XWikiContext context)
  ...
  public XWikiJcrPropertyVersioningStore(XWikiContext context) throws SecurityException,
  ...
  public void saveXWikiDocArchive(final XWikiDocumentArchive archivedoc, boolean bTransaction,
    ...
    try {
      ...
      throw new XWikiException(XWikiException.MODULE_XWIKI_STORE,
          XWikiException.ERROR_XWIKI_STORE_JCR_SAVING_OBJECT,
          "Exception while saving archive {0}", e, args);
    }
  }

  @Override
  public void loadXWikiDocArchive(final XWikiDocumentArchive archivedoc, boolean bTransaction,
    ...
    try {
      ...
      Object[] args = { new Long(archivedoc.getId()) };
      throw new XWikiException(XWikiException.MODULE_XWIKI_STORE,
          XWikiException.ERROR_XWIKI_STORE_JCR_LOADING_OBJECT,
  ...
  @Override
  public void resetRCSArchive(XWikiDocument doc, boolean bTransaction, XWikiContext context)
  ...
  @Override
  public XWikiDocument loadXWikiDoc(XWikiDocument basedoc, String version, XWikiContext context)
      throws XWikiException {
    try {
      ...
      throw new XWikiException(XWikiException.MODULE_XWIKI_STORE,
          XWikiException.ERROR_XWIKI_STORE_JCR_READING_VERSION,
  ...
  public Version[] getXWikiDocVersions(XWikiDocument doc, XWikiContext context)
    ...
    try {
      ...
      Object[] args = { doc.getFullName() };
      throw new XWikiException(XWikiException.MODULE_XWIKI_STORE,
          XWikiException.ERROR_XWIKI_STORE_JCR_READING_REVISIONS,
  ...
  public XWikiDocumentArchive getXWikiDocumentArchive(XWikiDocument doc, XWikiContext context)
      throws XWikiException {
    String key = ((doc.getDatabase() == null) ? "xwiki" : doc.getDatabase()) + ":"
        + doc.getFullName();
    synchronized (key) {
