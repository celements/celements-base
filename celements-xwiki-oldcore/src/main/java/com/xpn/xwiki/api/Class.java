...
public class Class extends Collection {
  ...
  public List<String> getEnabledPropertyNames() {
    List<com.xpn.xwiki.objects.classes.PropertyClass> properties = this.getBaseClass()
  ...
  /**
   * Get the names of the class properties that are disabled, and exist in the given object. This
   * list is a subset of
   * all the disabled properties in a class, since the object could have been created and stored
   * before some of the
  ...
  public List<String> getDisabledObjectPropertyNames(Object object) {
    List<com.xpn.xwiki.objects.classes.PropertyClass> properties = this.getBaseClass()
        .getDisabledObjectProperties(object.getBaseObject());
    List<String> result = new ArrayList<>(properties.size());
    for (com.xpn.xwiki.objects.classes.PropertyClass property : properties) {
      if (property != null) {
        result.add(property.getName());
  ...
  /**
   * Get the names of deprecated properties of the given object compared to the class. A deprecated
   * property is a
   * property which exists in the Object but doesn't exist anymore in the Class. This is used for
   * synchronization of
  ...
  public List<String> getDeprecatedObjectPropertyNames(Object object) {
    List<BaseProperty> properties = this.getBaseClass()
        .getDeprecatedObjectProperties(object.getBaseObject());
    List<String> result = new ArrayList<>(properties.size());
  ...
  public Element[] getProperties() {
    ...
    java.util.Collection<com.xpn.xwiki.objects.classes.PropertyClass> coll = getCollection()
        .getFieldList();
    if (coll == null) {
      return null;
    }
  ...
  public List<PropertyClass> getEnabledProperties() {
    List<com.xpn.xwiki.objects.classes.PropertyClass> enabledProperties = getBaseClass()
        .getEnabledProperties();
  ...
  public List<PropertyClass> getDisabledProperties() {
    List<com.xpn.xwiki.objects.classes.PropertyClass> disabledProperties = getBaseClass()
        .getDisabledProperties();
  ...
  public List<PropertyClass> getDisabledObjectProperties(Object object) {
    List<com.xpn.xwiki.objects.classes.PropertyClass> disabledObjectProperties = getBaseClass()
        .getDisabledObjectProperties(object.getBaseObject());
   ...
   * which exists in the Object but doesn't exist anymore in the Class. This is used for
  ...
  public List<Property> getDeprecatedObjectProperties(Object object) {
    List<BaseProperty> deprecatedObjectProperties = getBaseClass()
        .getDeprecatedObjectProperties(object.getBaseObject());
  ...
  public Element get(String name) {
    com.xpn.xwiki.objects.classes.PropertyClass property = (com.xpn.xwiki.objects.classes.PropertyClass) getCollection()
        .safeget(name);
    if (property != null) {
