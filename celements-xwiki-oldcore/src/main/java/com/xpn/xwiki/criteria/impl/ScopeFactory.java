...
public class ScopeFactory {
   ...
   *          A space name
   * @param deep
   *          <code>true</code> for matching all its pages; <code>false</code> for matching this
   *          space as a unit
   * @return A new Scope instance
   */
   ...
   *          A wiki name
   * @param deep
   *          <code>true</code> for matching all its spaces; <code>false</code> for matching this
   *          wiki as a unit
   * @return A new Scope instance
   */
