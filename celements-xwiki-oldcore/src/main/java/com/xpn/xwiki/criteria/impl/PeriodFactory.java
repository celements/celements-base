...
public class PeriodFactory {
   ...
   *
   * @param date
   *          The string representation of a date uniquely identifying a day. Use the "yyyyMMdd"
   *          format.
  ...
  /**
   * Creates a new Period instance that matches exactly the hour that includes the specified time
   * stamp.
   *
   * @param timestamp
   *          The milliseconds from 1970-01-01T00:00:00Z
  ...
  /**
   * Creates a new Period instance that matches all the instants between N hours before the
  ...
  /**
   * Creates a new Period instance that matches all the instants between N days before the
   * instantiation and the
   * instantiation.
   *
   * @param numberOfDays
  ...
  /**
   * Creates a new Period instance that matches all the instants between N weeks before the
   * instantiation and the
   * instantiation.
   *
   * @param numberOfWeeks
  ...
  /**
   * Creates a new Period instance that matches all the instants between N months before the
   * instantiation and the
   * instantiation.
   *
  ...
  /**
   * Creates a new Period instance that matches all the instants between N years before the
   * instantiation and the
   * instantiation.
   *
   * @param numberOfYears
   ...
   *
   * @param date
   *          The string representation of a date uniquely identifying a week. Use the "yyyyMMdd"
   *          format.
   * @return The corresponding Period object
   * @see java.text.SimpleDateFormat
   */
   ...
   *
   * @param date
   *          The string representation of a date uniquely identifying a month. Use the "yyyyMMdd"
   *          format.
   * @return The corresponding Period object
   * @see java.text.SimpleDateFormat
   */
   ...
   *
   * @param date
   *          The string representation of a date uniquely identifying a year. Use the "yyyyMMdd"
   *          format.
   * @return The corresponding Period object
   * @see java.text.SimpleDateFormat
   */
  ...
  /**
   * Creates a new Period instance that starts at the minimum value allowed by Date and ends at the
   * maximum value
   * allowed by Date.
   *
   * @return The corresponding Period object
