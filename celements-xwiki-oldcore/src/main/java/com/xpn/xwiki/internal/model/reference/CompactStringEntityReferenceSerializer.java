...
/**
 * Generate an entity reference string that doesn't contain reference parts that are the same as the
 * current entity in
 * the execution context. Note that the terminal part is always kept (eg the document's page for a
...
public class CompactStringEntityReferenceSerializer extends DefaultStringEntityReferenceSerializer {
   ...
   * {@inheritDoc}
   *
   * @see org.xwiki.model.internal.reference.DefaultStringEntityReferenceSerializer#serializeEntityReference(org.xwiki.model.reference.EntityReference,
   *      java.lang.StringBuilder, boolean, java.lang.Object[])
   */
  @Override
