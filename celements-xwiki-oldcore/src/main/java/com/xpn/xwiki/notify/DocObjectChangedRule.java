...
public class DocObjectChangedRule extends DocChangeRule {
  ...
  public boolean hasEqualsObjectsFromClass(XWikiDocument newdoc, XWikiDocument olddoc,
      String classname) {
    ...
    if ((vobj1 == null) || (vobj2 == null) || (vobj1.size() != vobj2.size())) {
      return false;
    }
  ...
  public boolean hasEqualsObjectsForAllClasses(XWikiDocument newdoc, XWikiDocument olddoc) {
    ...
    if ((fields1 == null) || (fields2 == null) || (fields1.size() != fields2.size())) {
      return false;
    }
