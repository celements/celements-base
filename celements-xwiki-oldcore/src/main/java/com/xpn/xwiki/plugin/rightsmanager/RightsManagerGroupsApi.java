...
public class RightsManagerGroupsApi extends Api {
   ...
   *
   * @param wikiName
   *          the name of the wiki where to search for groups.
  ...
  public int countAllMatchedWikiGroups(String wikiName, Map<?, ?> matchFields)
    ...
    try {
      count = RightsManager.getInstance().countAllWikiUsersOrGroups(false, wikiName,
          RightsManagerPluginApi.createMatchingTable(matchFields), this.context);
    } catch (RightsManagerException e) {
      logError(
          MessageFormat.format("Try to count all groups in wiki [{0}]", wikiName),
          e);
    }
  ...
  public int countAllMatchedGlobalGroups(Map<?, ?> matchFields) throws XWikiException {
    ...
    try {
      count = RightsManager.getInstance().countAllGlobalUsersOrGroups(false,
          RightsManagerPluginApi.createMatchingTable(matchFields), this.context);
    } catch (RightsManagerException e) {
  ...
  public int countAllMatchedLocalGroups(Map<?, ?> matchFields) throws XWikiException {
    ...
    try {
      count = RightsManager.getInstance().countAllLocalUsersOrGroups(false,
          RightsManagerPluginApi.createMatchingTable(matchFields), this.context);
    } catch (RightsManagerException e) {
   ...
   * @throws XWikiException
   *           error when searching for groups.
   */
   ...
   *           error when searching for groups.
   */
  public List<String> getAllMatchedGroupsNames(Map<?, ?> matchFields, int nb, int start)
      throws XWikiException {
  ...
  public List<String> getAllMatchedGroupsNames(Map<?, ?> matchFields, int nb, int start,
    ...
    try {
      groupList = (List<String>) RightsManager.getInstance().getAllMatchedUsersOrGroups(false,
          RightsManagerPluginApi.createMatchingTable(matchFields), false,
          new RequestLimit(nb, start),
  ...
  public List<String> getAllMatchedGlobalGroupsNames(Map<?, ?> matchFields, int nb, int start,
    ...
    try {
      groupList = (List<String>) RightsManager.getInstance().getAllMatchedGlobalUsersOrGroups(false,
          RightsManagerPluginApi.createMatchingTable(matchFields), false,
          new RequestLimit(nb, start),
          RightsManagerPluginApi.createOrderTable(order), this.context);
    } catch (RightsManagerException e) {
   ...
   *           error when searching for groups.
   */
  public List<String> getAllWikiGroupsNames(String wikiName, int nb, int start)
      throws XWikiException {
   ...
   *           error when searching for groups.
   */
  public List<String> getAllMatchedWikiGroupsNames(String wikiName, Map<?, ?> matchFields)
      throws XWikiException {
   ...
   *           error when searching for groups.
   */
  public List<String> getAllMatchedWikiGroupsNames(String wikiName, Map<?, ?> matchFields, int nb,
      int start)
      throws XWikiException {
  ...
  public List<String> getAllMatchedWikiGroupsNames(String wikiName, Map<?, ?> matchFields, int nb,
    ...
    try {
      groupList = (List<String>) RightsManager.getInstance().getAllMatchedWikiUsersOrGroups(false,
          wikiName,
          RightsManagerPluginApi.createMatchingTable(matchFields), false,
          new RequestLimit(nb, start),
          RightsManagerPluginApi.createOrderTable(order), this.context);
  ...
  public List<String> getAllMatchedLocalGroupsNames(Map<?, ?> matchFields, int nb, int start,
    ...
    try {
      groupList = (List<String>) RightsManager.getInstance().getAllMatchedLocalUsersOrGroups(false,
          RightsManagerPluginApi.createMatchingTable(matchFields), false,
          new RequestLimit(nb, start),
          RightsManagerPluginApi.createOrderTable(order), this.context);
    } catch (RightsManagerException e) {
   ...
   *           error when searching for groups.
   */
  public List<Document> getAllMatchedGroups(Map<?, ?> matchFields, int nb, int start)
      throws XWikiException {
  ...
  public List<Document> getAllMatchedGroups(Map<?, ?> matchFields, int nb, int start, List<?> order)
    ...
    try {
      List<XWikiDocument> xdocList = (List<XWikiDocument>) RightsManager.getInstance()
          .getAllMatchedUsersOrGroups(false,
   ...
   *           error when searching for groups.
   */
  public List<Document> getAllMatchedGlobalGroups(Map<?, ?> matchFields, int nb, int start)
      throws XWikiException {
  ...
  public List<Document> getAllMatchedGlobalGroups(Map<?, ?> matchFields, int nb, int start,
    ...
    try {
      List<XWikiDocument> xdocList = (List<XWikiDocument>) RightsManager.getInstance()
          .getAllMatchedGlobalUsersOrGroups(false,
              RightsManagerPluginApi.createMatchingTable(matchFields), true,
              new RequestLimit(nb, start),
              RightsManagerPluginApi.createOrderTable(order), this.context);
   ...
   *           error when searching for groups.
   */
  public List<Document> getAllMatchedWikiGroups(String wikiName, Map<?, ?> matchFields)
      throws XWikiException {
   ...
   *           error when searching for groups.
   */
  public List<Document> getAllMatchedWikiGroups(String wikiName, Map<?, ?> matchFields, int nb,
      int start)
      throws XWikiException {
  ...
  public List<Document> getAllMatchedWikiGroups(String wikiName, Map<?, ?> matchFields, int nb,
    ...
    try {
      List<XWikiDocument> xdocList = (List<XWikiDocument>) RightsManager.getInstance()
          .getAllMatchedWikiUsersOrGroups(false, wikiName,
              RightsManagerPluginApi.createMatchingTable(matchFields), true,
              new RequestLimit(nb, start),
              RightsManagerPluginApi.createOrderTable(order), this.context);
   ...
   *           error when searching for groups.
   */
  public List<Document> getAllMatchedLocalGroups(Map<?, ?> matchFields, int nb, int start)
      throws XWikiException {
  ...
  public List<Document> getAllMatchedLocalGroups(Map<?, ?> matchFields, int nb, int start,
    ...
    try {
      List<XWikiDocument> xdocList = (List<XWikiDocument>) RightsManager.getInstance()
          .getAllMatchedLocalUsersOrGroups(false,
              RightsManagerPluginApi.createMatchingTable(matchFields), true,
              new RequestLimit(nb, start),
              RightsManagerPluginApi.createOrderTable(order), this.context);
