...
public class LDAPPluginApi extends Api {
  ...
  public HashMap search(String searchstr, String[] params, HashMap connection)
      throws LDAPException {
    return plugin.search(searchstr, LDAPConnection.SCOPE_SUB, params, connection,
        getXWikiContext());
  }
   ...
   * server specified in the XWiki Preferences.
   * Bind to the LDAP server can be done using Admin binding (in this case bindusernamd and
   * bindpassword are not used)
  ...
  public boolean createUserFromLDAP(String wikiname, String uid, String bindusername,
      String bindpassword) throws XWikiException {
    if (hasProgrammingRights()) {
