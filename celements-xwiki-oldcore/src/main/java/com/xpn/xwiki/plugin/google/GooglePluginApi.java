...
public class GooglePluginApi extends Api {
  ...
  public String doSpellingSuggestion(String clientKey, String text)
  ...
  public byte[] doGetCachedPage(String clientKey, String url)
  ...
  public GoogleSearchResult doGoogleSearch(String clientKey, String query)
    ...
    return google.doGoogleSearch(clientKey, query, 0, 10, true,
        "", true, "", "", "");
  }
