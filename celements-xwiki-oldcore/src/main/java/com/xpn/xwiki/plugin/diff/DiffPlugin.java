...
public class DiffPlugin extends XWikiDefaultPlugin {
  ...
  public List getDifferencesAsList(String text1, String text2) throws XWikiException {
    try {
      ...
      throw new XWikiException(XWikiException.MODULE_XWIKI_DIFF,
          XWikiException.ERROR_XWIKI_DIFF_CONTENT_ERROR, "Diff of content generated an exception",
          e);
    }
  }
   ...
   * @return list of Delta objects
   */
  public String getDifferencesAsHTML(String text1, String text2, boolean allDoc)
