...
/**
 * Specialized version of the {@link AppServerTrustedAuthServiceImpl} that extract usernames out of
 * Kerberos principals.
 *
 * @version $Id$
 * @since 2.6.2
...
public class AppServerTrustedKerberosAuthServiceImpl extends XWikiAuthServiceImpl {
   ...
   * {@inheritDoc}
   *
   * @see com.xpn.xwiki.user.impl.xwiki.XWikiAuthServiceImpl#checkAuth(java.lang.String,
   *      java.lang.String,
   ...
   *
   * @param principal
   *          the principal to extract the username from
   * @return the extracted username
   */
  private String extractUsernameFromPrincipal(final String principal) {
    String username = principal;

    // Clears the Kerberos principal, by removing the domain part, to retain only the user name of
    // the
