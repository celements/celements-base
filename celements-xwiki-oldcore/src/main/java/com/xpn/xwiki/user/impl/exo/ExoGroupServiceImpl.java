...
public class ExoGroupServiceImpl extends XWikiGroupServiceImpl {
  ...
  public static OrganizationService getOrganizationService() {
    if (organizationService == null) {
      ...
      organizationService = (OrganizationService) manager
  ...
  public List<String> listAllGroups(XWikiContext context) throws XWikiException {
    ...
    try {
      ...
      Object[] args = {};
      throw new XWikiException(XWikiException.MODULE_XWIKI_ACCESS,
          XWikiException.ERROR_XWIKI_ACCESS_EXO_EXCEPTION_USERS, "Exception while listing groups",
          e, args);
    }
  }
   ...
   */
  @Override
  public List<String> getAllMatchedUsers(Object[][] matchFields, boolean withdetails, int nb,
      int start,
   ...
   */
  @Override
  public List<String> getAllMatchedGroups(Object[][] matchFields, boolean withdetails, int nb,
      int start,
      Object[][] order, XWikiContext context) throws XWikiException {
