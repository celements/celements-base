...
public interface XWikiGroupService {
   ...
   */
  void removeUserOrGroupFromAllGroups(String userOrGroupWiki, String userOrGroupSpace,
   ...
   *          containing {@link com.xpn.xwiki.doc.XWikiDocument}.
   * @param nb
   *          the maximum number of result to return. Infinite if 0.
   * @param start
   ...
   * @since XWiki Core 1.1.2, XWiki Core 1.2M2
   */
  Collection<String> getAllGroupsNamesForMember(String member, int nb, int start,
   ...
   *          the member. Can be either user or group.
   * @param limit
   *          the maximum number of result to return.
   * @param offset
   *          the index of the first found member to return.
   ...
   * @since 2.4M2
   */
  Collection<DocumentReference> getAllGroupsReferencesForMember(
   ...
   * @since 1.6M1
   */
  Collection<String> getAllMatchedMembersNamesForGroup(String group, String matchField,
      int nb, int start,
