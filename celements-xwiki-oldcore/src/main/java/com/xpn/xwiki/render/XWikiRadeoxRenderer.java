...
public class XWikiRadeoxRenderer implements XWikiRenderer {
  ...
  /**
   * We override this method from {@link org.radeox.engine.BaseRenderEngine} in order to provide our
   * own
  ...
  public String render(String content, XWikiDocument contentdoc, XWikiDocument contextdoc,
    ...
    if (rcontext.getRenderEngine() == null) {
      XWikiRadeoxRenderEngine radeoxengine = new XWikiRadeoxRenderEngine(this.initialRenderContext,
          this.filterPipe, context);
