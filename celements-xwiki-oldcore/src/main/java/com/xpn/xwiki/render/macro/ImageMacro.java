 ...
 * <li>halign: Horizontal alignment for the image. If missing, the image is displayed inline.
 * Accepted values:
 * floatleft, left, center, right, floatright</li>
 * <li>document: The document to which the file is attached. If missing, the current document is
 * used.</li>
 * <li>alt: The alt attribute of the image. If missing, title is used. If both are missing, use the
 * filename.</li>
 * <li>title: The title attribute of the image. If missing, alt is used. If both are missing, use
 * the filename.</li>
 * <li>link: Also link to the image.</li>
 * <li>fromIncludingDoc: If present, when the current document is included using #include*, use the
 * top level document
...
public class ImageMacro extends BaseLocaleMacro {
  ...
  public void execute(Writer writer, MacroParameter params)
    ...
    if ((null == useIncluder) || (useIncluder.indexOf("=") != -1)
        || useIncluder.toLowerCase().startsWith("f")) {
      useIncluder = null;
    }
