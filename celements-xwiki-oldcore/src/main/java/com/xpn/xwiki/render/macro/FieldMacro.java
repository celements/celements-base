...
/**
 * Radeox macro for the xwiki 1.0 syntax, which can display a property from an object attached to
 * the current document.
 * Syntax: <tt>{field:text|url|image}</tt>
 * <dl>
 * <dt>text</dt>
 * <dd>The name of the field to display. It can be prefixed with the short name of a class in the
 * "XWiki" space,
 * otherwise the name of the current document is assumed to be the target class.</dd>
 * <dt>mode</dt>
 * <dd>The display mode, one of the modes supported by the
 * {@link com.xpn.xwiki.api.Document#display(String, String)}
 * method: <tt>view</tt>, <tt>rendered</tt>, <tt>edit</tt>, <tt>search</tt>, <tt>hidden</tt>. If
 * missing, the current
 ...
 * Example:
 * <ul>
 * <li><tt>{field:title}</tt> displays the {@code title} field of the first object of the type
 ...
 * </ul>
 *
 * @deprecated It provides limited functionalities compared to the {@code doc.display} scripting
 *             API.
 * @version $Id$
 */
@Deprecated
