...
public abstract class XWikiDefaultURLFactory implements XWikiURLFactory {
  ...
  public URL createExternalURL(String web, String name, String action, String querystring,
    ...
    return createExternalURL(web, name, action, querystring, anchor, context.getDatabase(),
        context);
  }
  ...
  public URL createAttachmentURL(String filename, String web, String name, String action,
    ...
    return createAttachmentURL(filename, web, name, action, querystring, context.getDatabase(),
        context);
  }
  ...
  public URL createAttachmentRevisionURL(String filename, String web, String name, String revision,
      String querystring, XWikiContext context) {
    return createAttachmentRevisionURL(filename, web, name, revision, querystring,
        context.getDatabase(), context);
  }

  public URL createAttachmentRevisionURL(String filename, String web, String name, String revision,
      XWikiContext context) {
    return createAttachmentRevisionURL(filename, web, name, revision, null, context.getDatabase(),
        context);
  }
  ...
  /**
   * Converts a URL to a string representation. It's up to the implementation to decide whether to
   * perform
   * transformations or not on the URL. For example some implementations will convert the URL to a
   * relative URL
