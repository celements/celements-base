...
/**
 * Synchronizes the objects in a document with their current classes, by removing any deprecated
 * properties.
 *
 * @version $Id$
 * @since 2.4M2
...
public class ObjectsSynchronizeAction extends XWikiAction {
  ...
  public boolean action(XWikiContext context) throws XWikiException {
    ...
    xwiki.saveDocument(doc,
        context.getMessageTool().get("core.model.xobject.synchronizeObjects.versionSummary"),
        true, context);
