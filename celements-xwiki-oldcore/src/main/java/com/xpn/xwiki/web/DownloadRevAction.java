...
public class DownloadRevAction extends XWikiAction {
  ...
  public String render(XWikiContext context) throws XWikiException {
    ...
    if (context.getWiki().hasAttachmentRecycleBin(context)
      ...
      attachment = context.getWiki().getAttachmentRecycleBinStore().restoreFromRecycleBin(
          attachment, recycleId, context,
          true);
    ...
    if (attachment == null) {
      ...
      throw new XWikiException(XWikiException.MODULE_XWIKI_APP,
          XWikiException.ERROR_XWIKI_APP_ATTACHMENT_NOT_FOUND, "Attachment {0} not found", null,
          args);
    }
