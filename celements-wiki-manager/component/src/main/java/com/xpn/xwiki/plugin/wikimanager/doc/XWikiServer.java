...
public class XWikiServer extends DefaultXObjectDocument {
   ...
   * 
   * @param xdoc
   *          the encapsulated XWikiDocument.
   * @param objectId
   ...
   * 
   * @param wikiName
   *          the new name of the wiki.
   */
  public void setWikiName(String wikiName) {
    getDoc().setFullName(
        context.getMainXWiki() + ":" + sclass.getItemDocumentDefaultFullName(wikiName, context));
  }
   ...
   * 
   * @param description
   *          the new description of the wiki.
   */
   ...
   * 
   * @param server
   *          the new domain name of the wiki.
   */
   ...
   * 
   * @param visibility
   *          the new visibility of the wiki. Can be:
   *          <ul>
   *          <li>{@link XWikiServerClass#FIELDL_VISIBILITY_PUBLIC}</li>
   *          <li>{@link XWikiServerClass#FIELDL_VISIBILITY_PRIVATE}</li>
   *          </ul>
  ...
  public void setSecure(boolean secure) {
    setBooleanValue(XWikiServerClass.FIELD_SECURE, secure);
  }
   ...
   *           error occurred when creating the {@link URL}.
   */
   ...
   * 
   * @param pageFullName
   *          the page full name for which to get the complete {@link URL}.
   ...
   * 
   * @param spaceName
   *          the space name of the page for which to get the complete {@link URL}.
   * @param pageName
   *          the name of the page for which to get the complete {@link URL}.
   * @return the complete {@link URL} of the provided wiki page.
   * @throws MalformedURLException
   *           error occurred when creating the {@link URL}.
   */
  public URL getServerUrl(String spaceName, String pageName) throws MalformedURLException {
    ...
    if ((spaceName == null) || (pageName == null)) {
      ...
      url = context.getURLFactory().createURL(spaceName, pageName, "view", null, null,
          getWikiName(), context);
    }
