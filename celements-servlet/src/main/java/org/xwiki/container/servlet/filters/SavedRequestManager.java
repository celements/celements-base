...
public final class SavedRequestManager {
  ...
  private static final String SAVED_REQUESTS_KEY = SavedRequest.class.getCanonicalName()
      + "_SavedRequests";
  ...
  public static class SavedRequest {
    ...
    /**
     * The request URL; does not include the query string. The data is reused only if the new URL
     * matches this
     * value.
     */
     ...
     *
     * @param request
     *          the request that needs to be saved
     */
     ...
     * {@link javax.servlet.ServletRequest#getParameter(String)}.
     *
     * @param name
     *          the name of the parameter
     * @return The first value for this parameter, or <code>null</code> if no value was sent for
     *         this parameter.
     ...
     * @param name
     *          the name of the parameter
     * @return All the values for this parameter, or <code>null</code> if no value was sent for this
     *         parameter.
    ...
    /**
     * Retrieves the original URL used for this request, as a future request will be able to reuse
     * this data only if
  ...
  /**
   * Saves the data from a request and stores it in the current session. This method is not thread
   * safe, and does not
   * guarantee that saved requests are not overwritten, but given that this should only happen
   * sparingly, and that
  ...
  public static String saveRequest(HttpServletRequest request) {
    ...
    Map<String, SavedRequest> savedRequests = (Map<String, SavedRequest>) session
        .getAttribute(getSavedRequestKey());
  ...
  /**
   * Retrieves the original URL requested before a detour. This method returns something different
   * from
   * <code>null</code> only when there's a <em>srid</em> parameter in the current request,
   * indicating that there was
   * another request which data was saved, related to the current request.
   *
   * @param request
   *          the current request
   * @return the original requested URL that triggered a detour, or <code>null</code> if there isn't
   *         any original
   *         request information
   */
  @SuppressWarnings("unchecked")
  public static String getOriginalUrl(HttpServletRequest request) {
    ...
    if (savedRequests != null) {
      ...
      if (!StringUtils.isEmpty(identifier)) {
        SavedRequest savedRequest = savedRequests
            .get(request.getParameter(getSavedRequestIdentifier()));
