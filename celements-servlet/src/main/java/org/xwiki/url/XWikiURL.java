...
public interface XWikiURL {
   ...
   * For example these will find their way into the Query String when the XWiki URL serialized to a
   * standard URL.
   * Note that there can be several values for the same name (since this is allowed in URLs and we
   * want to map a URL to a XWiki URL). Also note that the order in the map is the same as the order
   * in the URL.
   *
  ...
  /**
   * @param name
   *          the parameter name for which to return the values
