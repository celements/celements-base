...
public class DefaultEventConverterManager implements EventConverterManager, Initializable {
  ...
  public void initialize() throws InitializationException {
    ...
    Collections.sort(this.localEventConverters, (eventConverter1,
        eventConverter2) -> eventConverter1.getPriority() - eventConverter2.getPriority());

    // sort remote events converters by priority
    Collections.sort(this.remoteEventConverters, (eventConverter1,
        eventConverter2) -> eventConverter1.getPriority() - eventConverter2.getPriority());
  }
