...
/**
 * This event can be canceled by the receiver. Sender of this event must take care of undoing any
...
public interface CancelableEvent extends Event {
   ...
   *
   * @return reason for cancel or null of the event was not canceled or canceled using
   *         {@link #cancel()}
   */
  String getReason();
