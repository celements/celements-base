...
/**
 * An event triggered whenever a client request (action) is processed, like <tt>/upload/</tt> or
 * <tt>/view/</tt>. A specific event corresponds to only one {@link #actionName action type}.
 *
 * @version $Id$
 */
