...
public class IdGenerator {
  ...
  public String generateUniqueId(String text) {
    // Note: We always use a prefix (and a prefix with alpha characters) so that the generated id is
    // a valid HTML id
  ...
  /**
   * Generate a unique id attribute using the passed text as the seed value. The generated id
   * complies with the XHTML
   ...
   * <ul>
   * <li>Remove white spaces: Clean white space since otherwise they'll get transformed into 20 by
   * the below and thus
