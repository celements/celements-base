 ...
 * buffer. This allows
 * accumulating some content before it's flushed. This feature is used for example in the XWiki
 * Syntax Renderer to
 * accumulate text so that it be reviewed and escaped before printed (indeed some text has some
