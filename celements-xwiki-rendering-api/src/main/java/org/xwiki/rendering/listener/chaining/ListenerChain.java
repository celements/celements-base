...
/**
 * Stores information about the listeners in the chain and the order in which they need to be
 * called. Also sports a
 * feature that allows pushing and popping listeners that are stackable. This feature is useful
 * since listeners can hold
 * stateful information and sometimes you may need to push new versions of them to start with new
...
public class ListenerChain {
  ...
  /**
   * The ordered list of listeners. We only allow one instance per listener class name so we just
   * need to store the
  ...
  /**
   * @param listenerClass
   *          the listener to remove from the chain
   */
  ...
  /**
   * @param listenerClass
   *          the listener for which we need to find the next listener in the chain
  ...
  /**
   * @param listenerClass
   *          the listener class for which we want to find the listener instance
   * @return the listener instance corresponding to the passed class. Note that the last instance of
   *         the stack is
   *         returned
   */
  ...
  /**
   * @param listenerClass
   *          the listener class for which to find the position in the chain
