...
public class ResourceReference implements Cloneable {
  ...
  /**
   * @return true if the resource type has been explicitly provided (eg in XWiki Syntax 2.1 if the
   *         reference is
  ...
  /**
   * In order for Resource references to be extensible we allow for extra parameters in addition to
   * the Resource
   * reference. For example this is used in Document Resource References for storing the query
   * string and anchor
