...
public class BlockTest {
  ...
  public void testGetBlocksByType() {
    ParagraphBlock pb1 = new ParagraphBlock(
        Arrays.<Block>asList(new HeaderBlock(Arrays.<Block>asList(new WordBlock("title1")),
            HeaderLevel.LEVEL1)));
    ParagraphBlock pb2 = new ParagraphBlock(
        Arrays.<Block>asList(new HeaderBlock(Arrays.<Block>asList(new WordBlock("title2")),
            HeaderLevel.LEVEL2)));
  ...
  public void testReplaceBlock() {
    // It's important all blocks have same content to make sure replacement api don't find the
    // position of the
