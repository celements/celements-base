 ...
 * </p>
 * <p>
 * So basically we would create an instance like <code>new ExtractHandler(0, 400)</code> in order to
 * obtain an XML
 ...
 * <br/>
 * is:<br/>
 * <code>&lt;p&gt;ck &lt;a href="realyLongURL" title="Here"&gt;here&lt;/a&gt; to&lt;/p&gt;</code>
 * </p>
 *
 * @version $Id$
 * @since 1.6M2
...
public class ExtractHandler extends DefaultHandler {
  ...
  /**
   * <code>true</code> if the extraction was successful. The parsing process throws an exception
   * when the upper
